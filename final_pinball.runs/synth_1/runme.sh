...
HD_PWD='Z:/Documents/Xilinx Projects/Pinball/final_pinball/final_pinball.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_display.tcl
