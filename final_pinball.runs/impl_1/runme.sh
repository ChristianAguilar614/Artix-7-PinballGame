...
HD_PWD='Z:/Documents/Xilinx Projects/Pinball/final_pinball/final_pinball.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_display.tcl -notrace
